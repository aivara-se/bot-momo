...
- **Host** — GitHub Pages (`aivara-se/bot-momo`)
...
Until the custom domain answers, the site is reachable at `https://aivara-se.github.io/bot-momo/`.
...
|---|---|---|---|
| `CNAME` | `momo` | `aivara-se.github.io` | **DNS only (grey cloud)** |
